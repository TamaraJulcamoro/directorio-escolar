...
export default function StudentModal({ student, onClose }) {
  ...
  // Helper para renderizar un número con enlace tel:
        ...
        <div className="modal-body">
          ...
          <div className="info-section">
            ...
            <div className="info-grid">
              ...
              <div className="info-item">
                ...
                <span className="value">{renderPhone(student.padreCelular)}</span>
              </div>
              <div className="info-item" style={{ gridColumn: '1 / -1' }}>
          ...
          <div className="info-section">
            ...
            <div className="info-grid">
              ...
              <div className="info-item">
                <span className="label">Celular</span>
                <span className="value">{renderPhone(student.madreCelular)}</span>
              </div>
              <div className="info-item" style={{ gridColumn: '1 / -1' }}>
                <span className="label">Dirección del domicilio actual</span>
          ...
          <div className="info-section">
            ...
            <div className="info-grid">
              ...
              <div className="info-item" style={{ gridColumn: '1 / -1' }}>
                ...
                <span className="value">{renderPhone(student.apoderadoCelular)}</span>
              </div>
            </div>
          </div>
        </div>
